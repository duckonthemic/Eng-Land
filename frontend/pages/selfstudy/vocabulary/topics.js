  ...
  const topics = [
    {
      ...
      image:
        "https://www.aimsindia.com/wp-content/uploads/2022/06/world-environment.png",
      link: "topics/environment",
    },
    {
      title: "Chủ đề gia đình",
      description:
        "Học cách bày tỏ tình yêu, hỗ trợ và sự thấu hiểu trong gia đình bạn.",
      image:
        "https://luyenthiielts7.com/wp-content/uploads/2020/10/Family-Silhouette-3.jpg",
      link: "topics/family",
    },
    {
      title: "Chủ đề công việc",
      description:
        "Nâng cao trình độ giao tiếp của bạn và đạt được thành công trong sự nghiệp.",
      image:
