  ...
  return (
    <main className="min-h-screen bg-gradient-to-r from-green-100 to-blue-100 py-12">
      <div className="container mx-auto px-6">
        <h1 className="text-5xl font-bold mb-10 text-center text-indigo-700">Học Cùng Nhau</h1>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {filteredGroups.length > 0 ? (
            filteredGroups.map(group => (
              <div key={group.id} className="bg-white shadow-2xl rounded-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <div className="p-6">
                  <h2 className="text-2xl font-bold mb-3 text-indigo-600">{group.name}</h2>
            ...
            <p className="text-center text-indigo-700 col-span-full">Không tìm thấy nhóm học nào phù hợp.</p>
          )}
        </div>
      </div>
    </main>
