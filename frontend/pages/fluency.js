    ...
    <div className="fluency-page bg-white text-gray-800">
      ...
      <header className="relative bg-gradient-to-b from-green-600 to-green-400 text-white py-24 text-center">
        ...
        <p className="mt-6 text-2xl max-w-3xl mx-auto">
          Phát triển kỹ năng ngôn ngữ để giao tiếp tự tin và lưu loát trong công
          việc và cuộc sống.
        </p>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div className="text-gray-700 space-y-6">
            <h2 className="text-4xl font-bold text-green-700">
              Vì Sao Cần Lưu Loát Tiếng Anh?
            </h2>
            <p>
              Lưu loát tiếng Anh không chỉ giúp bạn giao tiếp hiệu quả mà còn mở
              ra những cơ hội nghề nghiệp rộng lớn. Kỹ năng này đóng vai trò
              then chốt trong việc thể hiện bản thân, tham gia các cuộc họp, và
              thuyết phục người khác.
            </p>
            <p>
              Với chương trình học của chúng tôi, bạn sẽ trở thành một người sử
              dụng tiếng Anh tự tin thông qua các bài tập thực tế, tình huống mô
              phỏng, và các khóa học chuyên sâu.
            </p>
            <a
              href="#register"
      ...
      <section className="py-20 px-6 md:px-20 bg-gradient-to-b from-white to-green-50">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-green-700">
            Lộ Trình Trở Nên Lưu Loát
          </h2>
          <p className="mt-4 text-lg max-w-xl mx-auto">
            Chúng tôi sẽ giúp bạn tiến bộ qua từng bước, giúp bạn từ việc học cơ
            bản đến giao tiếp chuyên nghiệp.
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                "Học các từ vựng và cấu trúc ngữ pháp cần thiết để tạo nền tảng vững chắc.",
            ...
            },
            {
              ...
              description:
                "Phát triển kỹ năng nghe và nói qua các tình huống giao tiếp thực tế.",
            ...
            },
            {
              ...
              description:
                "Áp dụng những gì đã học để giao tiếp tự tin và lưu loát trong mọi tình huống.",
      ...
      <section className="py-24 px-6 md:px-20 bg-gradient-to-b from-green-50 to-green-100">
        <div className="text-center mb-16">
          ...
          <p className="text-lg mt-4 text-gray-600 max-w-xl mx-auto">
            Eng Land cam kết giúp bạn trở nên lưu loát với chương trình học hiện
            đại, phù hợp với nhu cầu và mục tiêu cá nhân của bạn.
          </p>
        </div>
      ...
      >
        ...
        <p className="text-lg mb-8">
          Tham gia khóa học ngay hôm nay để bắt đầu hành trình trở thành người
          giao tiếp lưu loát!
        </p>
        <a
          href="/courses/4"
