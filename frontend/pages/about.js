        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <section className="text-center animate-fade-in">
            ...
            <p className="text-lg md:text-xl">
              Eng Land là nền tảng học tiếng Anh trực tuyến hàng đầu, mang đến
              cho bạn những công cụ và tài nguyên cần thiết để nâng cao kỹ năng
              ...
              {[
                {
                  ...
                  alt: "Award",
                  text: "Giải thưởng giáo dục 2023",
                },
                {
                  src: "/images/user.jpg",
                  alt: "Users",
                  text: "+10,000 người dùng hài lòng",
                },
                {
                  src: "/images/certificate.jpg",
                  alt: "Certification",
                  text: "Chứng nhận ISO 9001",
                },
              ].map((item, index) => (
                <div
                  key={item.src}
          ...
          <section className="animate-fade-in">
            ...
            <p className="text-lg mb-6 text-center md:text-left">
              Chúng tôi cam kết cung cấp một nền tảng học tiếng Anh chất lượng
              cao, giúp người học tự tin giao tiếp quốc tế, mở rộng cơ hội nghề
              nghiệp và kết nối toàn cầu.
            </p>
            <div className="flex flex-col md:flex-row items-center md:space-x-4">
              ...
              <div className="md:w-1/2 mt-6 md:mt-0">
                <ul className="list-disc pl-5 space-y-3 text-black text-xl">
                  <li>
                    Phát triển các khóa học linh hoạt và cập nhật liên tục.
                  </li>
                  <li>Tạo ra môi trường học tập tương tác và thú vị.</li>
                  <li>Hỗ trợ học viên qua các kênh liên lạc đa dạng.</li>
                  <li>
                    Giúp học viên tiếp cận với giáo viên nước người giàu kinh
                    nghiệm.
                  </li>
                  <li>
                    Không chỉ là học, học viên sẽ được tiếp xúc với nhiều phương
                    pháp học tập khác nhau từ nhiều quốc gia.
                  </li>
                  <li>
                    Đảm bảo chất lượng giảng dạy thông qua đội ngũ chuyên gia
                    trong và ngoài nước.
                  </li>
                </ul>
              </div>
          ...
          <section className="animate-fade-in">
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-lg">
                    "Eng Land đã giúp tôi cải thiện kỹ năng tiếng Anh một cách
                    đáng kể. Thầy cô nhiệt tình và quan tâm đến học sinh kể cả
                    học online"
                  </p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-lg">
                    "Nhờ Eng Land, tôi đã tự tin giao tiếp bằng tiếng Anh trong
                    môi trường làm việc quốc tế. Tham gia vào thị trường anime
                    quốc tế một cách thoải mái"
                  </p>
                  <p className="mt-2 font-semibold">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-lg">
                    "Các khóa học linh hoạt và hỗ trợ từ giáo viên đã giúp em
                    học tiếng Anh hiệu quả hơn. Qua đây, em đã có nhiều trải
                    nghiệm với giáo viên trong và ngoài nước, đồng thời còn tiếp
                    thu được văn hóa học tập của các giáo viên nước ngoài"
                  </p>
                  <p className="mt-2 font-semibold">- Hoàng Bảo Long -</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              {[
                ...
                <div key={index}>
                  <p className="text-4xl font-bold text-primary-light-green">
                    {stat.number}
                  </p>
          ...
          <section className="text-center animate-fade-in">
            ...
            <p className="text-lg mb-6">
              Tham gia cộng đồng học viên Eng Land và trải nghiệm phương pháp
              học tiếng Anh hiệu quả nhất.
            </p>
            <Link
              href="/courses"
              className="inline-block bg-primary-light-green text-green py-3 px-6 rounded-lg font-semibold hover:bg-primary-dark-green hover:text-green transition-colors duration-300"
            >
